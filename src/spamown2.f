      ...
      integer(8) nrow,ncol,nnz,ir(*),jc(*),jao(*),iao(*)

      integer(8) kk,k,i,j,tmpi, cr(nrow), ig(nrow+1), g(nnz)
      integer(8) st(nrow+1)
...
c-----------------------------------------------------------------------
      ...
      integer(8)     newnnz,   ipos,   k,  i, j, tmp1, tmp2
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer(8) nrow, len, ia(nrow+1), ja(*), j(len)
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer(8) nrow, len, ia(nrow+1), ja(*), j(len), kk
      double precision  a(*), x(len)
c
c
c
