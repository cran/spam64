...
c
      character  type*6
      integer(8)    bounds , ierr   , ih    , ihb   , ihd   ,
     &           iq     , iw     , j     , k     , ldh   ,
...
c     %---------------%
c
      integer(8)    kevd2, msglvl
      logical(8)    dsgetstrue
c
c     %----------------------%
c     | External Subroutines |
c     %----------------------%
...
c     %---------------%
c
      integer(8)    bounds, ierr, ih, iq, ishift, iw, 
...
c
      character  bmat*1, which*2
      integer(8)    ido, info, ishift, ldh, ldq, ldv, mxiter,
     &           n, mode, nev, np
      Double precision
     &           tol
c
...
c
      character  wprime*2
      logical(8)    cnorm, getv0, initv, update, ushift, dsaup2true
      integer(8)    ierr, iter, j, kplusp, msglvl, nconv, nevbef, nev0, 
...
c
      character  bmat*1
      integer(8)    ido, info, k, ldh, ldv, n, mode, np
      Double precision
     &           rnorm
c
c     %-----------------%
...
c
      ...
      integer(8)    i, ierr, ipj, irj, ivj, iter, j, msglvl, 
     &           infol, jj
      Double precision
...
c     %---------------%
c
      integer(8)    i, iend, istart, itop, j, jj, kplusp, msglvl
      logical(8)    first
      Double precision
...
c     ..
c     .. local scalars ..
      integer(8)            i, icompz, ii, iscale, j, jtot, k, l, l1, lend,
