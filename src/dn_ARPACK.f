...
c
      ...
      logical(8)    rvec
      integer(8)    info, ldz, ldv, lworkl, n, ncv, nev
      Double precision      
     &           sigmar, sigmai, tol
c
c     %-----------------%
...
c
      character  type*6
      integer(8)    bounds, ierr  , ih    , ihbds   , 
...
c
      ...
      integer(8)    ido, info, ldv, lworkl, n, ncv, nev
      Double precision
     &           tol
c
c     %-----------------%
...
c     %---------------%
c
      integer(8)    bounds, ierr, ih, iq, ishift, iupd, iw, 
...
c
      character  bmat*1, which*2
      integer(8)    ido, info, ishift, mode, ldh, ldq, ldv, mxiter,
     &           n, nev, np
      Double precision
     &           tol
c
...
c
      character  wprime*2
      logical(8)    cnorm , getv0, initv, update, ushift, dnatrue
      integer(8)    ierr  , iter , j    , kplusp, msglvl, nconv, 
...
c     %------------------%
c
      integer(8)    kev, ldh, ldq, ldv, n, np
c
c     %-----------------%
c     | Array Arguments |
c     %-----------------%
...
c     %------------------------%
c
      integer(8)    i, iend, ir, istart, j, jj, kplusp, msglvl, nr
      logical(8)    cconj, first
      Double precision
...
c     % analogue for dneighone
      logical(8)    select(1), dneightrue
      integer(8)    i, iconj, msglvl, dneighone 
      Double precision     
     &           temp, vl(1)
c
c     %----------------------%
...
c     %------------------------%
c
      integer(8)    i, i1, i2, itn, its, j, k, l, m, nh, nr
      integer(8)    dlqthree
     &
...
c
      character  bmat*1
      integer(8)    ido, info, k, ldh, ldv, n, nb, np
      Double precision
     &           rnorm
c
c     %-----------------%
...
c     %---------------%
c
      logical(8)    first, orth1, orth2, rstart, step3, step4
      integer(8)    ierr, i, infol, ipj, irj, ivj, iter, itry, j, msglvl,
     &           jj
      integer(8)    dnaitrone
