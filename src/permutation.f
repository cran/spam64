...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer(8) nrow,ja(*),ia(nrow+1),jao(*),iao(nrow+1),perm(nrow)
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer(8) nrow,ja(*),ia(nrow+1),jao(*),iao(nrow+1),perm(*)
      double precision a(*), ao(*)
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer(8) nrow,ja(*),ia(nrow+1),jao(*),iao(nrow+1),pperm(nrow),
     +        qperm(*)
      double precision a(*),ao(*)
c-----------------------------------------------------------------------
...
c----------------------------------------------------------------------c
c local variables
      integer(8) ii,k,j,next,init,tmp, tmp1
c
      init      = 1
      tmp       = ix(init)
      ii        = perm(init)
...
c-----------------------------------------------------------------------
      ...
      implicit none
      integer(8) nrow, ncol, nnz
      integer(8) ja(*),jb(*),ia(nrow+1),ib(nrow+1),iw(ncol),ndegr(nrow)
c-----------------------------------------------------------------------
...
c
c-----------------------------------------------------------------------
      integer(8) k,j,ii,jr,last,ldg,jc
